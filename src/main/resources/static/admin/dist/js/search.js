$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '出发点', name: 'ticket_from', index: 'ticket_from', width: 80},
            {label: '终点', name: 'ticket_to', index: 'ticket_to', width: 80},
            // formatter: coverImageFormatter
            {label: '购票人', name: 'ticket_payer', index: 'ticket_payer', width: 60},
            {label: '购票数', name: 'ticket_count', index: 'ticket_count', width: 60, },
            {label: '出发时间', name: 'start_time', index: 'start_time', width: 60, },
            {label: '到达时间', name: 'end_time', index: 'end_time', width: 60, },
            {label: '购票时间', name: 'buy_time', index: 'buy_time', width: 60},
            {label: '支付时间', name: 'pay_time', index: 'pay_time', width: 120},
            {label: '订单状态', name: 'ticket_status', index: 'ticket_status', width: 60, formatter: statusFormatter}
        ],
        height: 560,
        rowNum: 10,
        rowList: [10, 20, 50],
